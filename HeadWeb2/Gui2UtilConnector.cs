...
namespace HeadWeb
{
    internal class Gui2UtilConnector
    {
        ...
        static int UtilTimeout = 15;  // seconds
        System.Timers.Timer timeoutTimer = new System.Timers.Timer(UtilTimeout * 1000) { AutoReset = false };
        ...
        void StopBackgroundTask(bool byUserRequest)
        {
            ...
            {
                Log.Info("Aborting background thread{0}.", byUserRequest ? " by User Request" : "");
