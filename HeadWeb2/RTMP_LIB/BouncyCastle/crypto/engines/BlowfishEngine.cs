		...
		: IBlockCipher
    {
        ...
        */
        private void EncryptBlock(
            ...
            int     dstIndex)
        {
            uint xl = LittleEndian ? Pack.LE_To_UInt32(src, srcIndex) : Pack.BE_To_UInt32(src, srcIndex);
            uint xr = LittleEndian ? Pack.LE_To_UInt32(src, srcIndex + 4) : Pack.BE_To_UInt32(src, srcIndex + 4);
